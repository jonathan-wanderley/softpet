            ...
            >
                <div className="px-[12px] w-full">
                    <div className="flex gap-[7px] items-center">
                        ...
                        <span className="text-[16px] font-normal text-white">Raça: {petInfo.breed}</span>
                    </div>

                    <div className="flex gap-[7px] items-center">
                        <PhoneIcon size={16} />

                        <span className="text-[16px] font-normal text-white">Telefone: {petInfo.phone}</span>
                    </div>

                    <div className="flex gap-[7px] items-center">
                        <CalendarIcon size={16} />

                        <span className="text-[16px] font-normal text-white">Idade: {format(new Date(`${petInfo.birthdate}T00:00`), "dd/MM/yyyy")}</span>
                    </div>
                </div>
